...
export default  React.createClass({
  ...
  render: function() {
    ...
    if (this.state.loading) {
      ...
      mainSection = <SortableTable actions={this.props.actions} rows={visibleResults} columns={this.props.columnDefinitions()} sortHandler={this.handleSort()} currentSort={this.state.currentSort}/>;
    }
